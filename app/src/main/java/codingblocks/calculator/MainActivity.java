...
//-------------------------SPEECH-----------------------------------------
        ...
        btnLayout = (LinearLayout) findViewById(R.id.whole_layout);
...
//                    case "Tu":
                    ...
                    default:
                        ...
                        if(flag==1){
                            Log.d("speechCont: ", str);
                            for(int i=0;i<str.length();i++){
                                Button btn = (Button) findViewById(R.id.whole_layout).findViewWithTag(str.charAt(i)+"");
                                btn.performClick();
                            }
                        }
                        else{
...
//            }
            ...
            // String matches = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
        }
    }
